...
``` bash
curl -s https://raw.githubusercontent.com/mina2047/Hello-odoo12/master/run.sh | sudo bash -s odoo-two 11012 21012
```
...
``` sh
$ git clone https://github.com/mina2047/Hello-odoo12.git
